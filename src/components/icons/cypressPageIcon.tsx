  ...
  return (
    ...
    >
      <path
        ...
        className={`dark:fill-[#2B2939] fill-[#D3D3D3] text-xl transition-all group-hover/native:fill-Washed-Purple/washed-purple-400/75`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        className={`dark:fill-[#817EB5]  fill-Neutrals/neutrals-7 transition-all group-hover/native:fill-Washed-Blue/washed-blue-500/75`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
