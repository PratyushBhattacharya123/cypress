...
const Header = () => {
  ...
  return (
    <header className="p-4 flex justify-center items-center">
      ...
      <NavigationMenu className="hidden md:block dark:border-[1px] rounded-full py-1 px-3 pr-6 dark:border-neutral-800">
        <NavigationMenuList className="gap-6">
          <NavigationMenuItem>
            <NavigationMenuTrigger
              onClick={() => setPath("#resources")}
              className={cn("font-normal text-xl", {
            ...
            <NavigationMenuContent>
              <ul className="grid p-6 gap-3 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
